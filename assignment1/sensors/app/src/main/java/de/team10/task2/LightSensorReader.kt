...
class LightSensorReader : Service(), SensorEventListener {
    ...
    private fun startForegroundService() {
        ...
        val notification: Notification = NotificationCompat.Builder(this, channelId)
            .setContentTitle("LightSensorService")
    ...
    private fun checkThreshold() {
        if (value.compareTo(threshold) >= 0) {
            ...
            println("SEND THRESHOLD")
            val intent = Intent("de.team10.task2.timer.light.THRESHOLD").apply {
    ...
    private fun sendUpdate() {
        val intent = Intent("de.team10.task2.timer.light.UPDATE").apply {
            putExtra("value", value)
        }
        broadcastManager.sendBroadcast(intent)
    }
